app.controller("MarketWiseBonusCtrl", function ($scope, $http, uiGridConstants, uiGridExporterService) {
    ...
    $scope.gridMarketWiseBonus = {
        showColumnFooter: true,
        enableFiltering: true,
        enableSorting: true,
        columnDefs: columnMarketWiseBonus,
        enableGridMenu: true,
    ...
    $scope.OnReportTypeChange = function () {
        ...
        if ($scope.frmMarketWiseBonus.RepType.ReportTypeValue == "Today" || $scope.frmMarketWiseBonus.RepType.ReportTypeValue == "Yesterday" || $scope.frmMarketWiseBonus.RepType.ReportTypeValue == "LastSevendays" || $scope.frmMarketWiseBonus.RepType.ReportTypeValue == "LastThirtydays" || $scope.frmMarketWiseBonus.RepType.ReportTypeValue == "CurrentMonth" || $scope.frmMarketWiseBonus.RepType.ReportTypeValue == "LastMonth") {
            $scope.isDisabled = true;
            $scope.FromDate = "";
            $scope.ToDate = "";
    ...
    $scope.GetMarketWiseBonus = function () {

        if ($scope.frmMarketWiseBonus.RepType.ReportTypeValue == "MarketWiseBonus") {
            if ($scope.ToDate == "" || $scope.ToDate == undefined || $scope.ToDate == null) {
                ...
                if (eDate >= todayDate) {
                    ...
                    methodName = "GetMarketWiseBonusCustomDate";
        ...
        $http({
            method: "POST",
            url: MyApp.rootPath + "MarketWiseBonus/" + methodName,
            data: {
                fDate: $scope.FromDate,
                tDate: $scope.ToDate,
                dCode: $scope.frmMarketWiseBonus.Division.DivisionCode,
                rCode: $scope.frmMarketWiseBonus.Region.RegionCode,
                aCode: $scope.frmMarketWiseBonus.Area.AreaCode,
                tCode: $scope.frmMarketWiseBonus.Territory.TerritoryCode,
                cCode: $scope.frmMarketWiseBonus.Customer.CustomerCode

            }
        }).then(function (response) {
            if (response.data.length > 0) {
                $scope.gridMarketWiseBonus.data = response.data;

            }
            else {
                toastr.warning("No Data Found!", '');
                $scope.gridMarketWiseBonus.data = [];
            }
        }, function (response) {
    ...
    $scope.OnDivisionClick = function () {
        ...
        $http({
            ...
            params: { dCode: $scope.frmMarketWiseBonus.Division.DivisionCode }
        }).then(function (response) {
            if (response.data.Data.length > 0) {
    ...
    $scope.OnRegionClick = function () {
        ...
        $http({
            ...
            params: { dCode: $scope.frmMarketWiseBonus.Division.DivisionCode, rCode: $scope.frmMarketWiseBonus.Region.RegionCode }
        }).then(function (response) {
    ...
    $scope.OnAreaClick = function () {
        ...
        $http({
            ...
            params: { dCode: $scope.frmMarketWiseBonus.Division.DivisionCode, rCode: $scope.frmMarketWiseBonus.Region.RegionCode, aCode: $scope.frmMarketWiseBonus.Area.AreaCode }
        }).then(function (response) {
            if (response.data.Status === "" || response.data.Status === null) {
                if (response.data.Data.length > 0) {
    ...
    $scope.OnTerritoryClick = function () {
        ...
        $http({
            ...
            params: { dCode: $scope.frmMarketWiseBonus.Division.DivisionCode, rCode: $scope.frmMarketWiseBonus.Region.RegionCode, aCode: $scope.frmMarketWiseBonus.Area.AreaCode, tCode: $scope.frmMarketWiseBonus.Territory.TerritoryCode }
        }).then(function (response) {
            if (response.data.Status === "" || response.data.Status === null) {
                if (response.data.Data.length > 0) {
    ...
    $scope.OnCustomerClick = function () {
        ...
        $http({
            ...
            params: { dCode: $scope.frmMarketWiseBonus.Division.DivisionCode, rCode: $scope.frmMarketWiseBonus.Region.RegionCode, aCode: $scope.frmMarketWiseBonus.Area.AreaCode, tCode: $scope.frmMarketWiseBonus.Territory.TerritoryCode, cCode: $scope.frmMarketWiseBonus.Customer.CustomerCode }
        }).then(function (response) {
            if (response.data.Status === "" || response.data.Status === null) {
                if (response.data.Data.length > 0) {
    ...
    $scope.Reset = function () {
        ...
        $scope.isDisabled = false;
        $scope.ReportType = "";
        $scope.frmMarketWiseBonus.Division = undefined;
        $scope.frmMarketWiseBonus.Region = undefined;
        $scope.frmMarketWiseBonus.Area = undefined;
        $scope.frmMarketWiseBonus.Territory = undefined;
        $scope.frmMarketWiseBonus.Customer = undefined;

        $scope.frmMarketWiseBonus.RepType = undefined;
