...
{
    public class AreaProductImsDAL : ReturnData
    {
        ...
        //Function
        public object GetAreaProductImsDateRange(string fDate, string tDate, string dCode, string aCode)
        {
            try
            {
                ...
                using (OracleConnection objConn = new OracleConnection(ConnString))
                {
                    using (OracleCommand objCmd = new OracleCommand())
                    {
                        ...
                        objCmd.CommandText = "FN_AREA_PROD_IMS";
                        ...
                        _dbHelper.InsertReportAudit("Area Wise Product IMS(Custom Date)");
                        List<AreaProductImsBEL> item;
                        item = (from DataRow row in dt.Rows
                                select new AreaProductImsBEL
                                {
