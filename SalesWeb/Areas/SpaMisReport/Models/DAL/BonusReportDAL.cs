...
{
    public class BonusReportDAL : ReturnData
    {
        ...
        public object GetBonusReportCustomDate(string fDate, string tDate, string dCode, string rCode, string aCode, string tCode, string cCode)
        {
            try
            {
                using (OracleConnection objConn = new OracleConnection(ConnString))
                {
                    using (OracleCommand objCmd = new OracleCommand())
                    {
                        ...
                        objCmd.CommandText = "FN_BONUS_DR_REPORT";
