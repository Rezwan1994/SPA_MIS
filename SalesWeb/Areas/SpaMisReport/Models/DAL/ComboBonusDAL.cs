...
{
    public class ComboBonusDAL:ReturnData
    {
        ...
        public object GetComboBonusCustomDate(string fDate, string tDate, string dCode, string rCode, string aCode, string tCode, string cCode, string cbNo)
        {
            try
            {
                using (OracleConnection objConn = new OracleConnection(ConnString))
                {
                    using (OracleCommand objCmd = new OracleCommand())
                    {
                        ...
                        objCmd.CommandText = "FN_COMBO_BONUS_DR_REPORT";
                        ...
                        List<ComboBonusBEL> item;
                        item = (from DataRow row in dt.Rows
                                select new ComboBonusBEL
                                {
                                    ...
                                    ReturnSalesQty = row["RETURN_SALES_QTY"].ToString(),
                                    ...
                                    ComboBonusQty = row["COMBO_BONUS_QTY"].ToString(),
                                    ReturnComboBonusQty = row["RETURN_COMBO_BONUS_QTY"].ToString(),
                                    NetComboBonusQty = row["NET_COMBO_BONUS_QTY"].ToString(),
                                }).ToList();
                        return item;
                    }
                }
