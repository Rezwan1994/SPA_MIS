...
{
    public class FsoWiseImsDAL : ReturnData
    {
        ...
        public object GetFsoWiseImsDateRange(string fDate, string tDate, string dCode, string rCode, string aCode, string tCode, string cCode)
        {
            ...
            try
            {
                using (OracleConnection objConn = new OracleConnection(ConnString))
                {
                    using (OracleCommand objCmd = new OracleCommand())
                    {
                        ...
                        objCmd.CommandText = "fn_Fso_Ims_Date_Range";
                        ...
                        _dbHelper.InsertReportAudit("FSO Wise IMS(Custom Date)");
                        List<FsoWiseImsBEL> item;
                        item = (from DataRow row in dt.Rows
                                select new FsoWiseImsBEL
                                {
                                    ...
                                    NoOfInvoice = Convert.ToDouble(row["NO_OF_INVOICE"]),
