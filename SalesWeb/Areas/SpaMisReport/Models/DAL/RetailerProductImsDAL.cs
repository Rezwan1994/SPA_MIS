...
{
    public class RetailerProductImsDAL : ReturnData
    {
        ...
        public object GetRetailerProductImsToday(string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                ...
                using (OracleConnection objConn = new OracleConnection(ConnString))
                {
                    using (OracleCommand objCmd = new OracleCommand())
                    {
                        ...
                        objCmd.CommandText = "FN_RET_PROD_IMS_TODAY";
                        ...
                        _dbHelper.InsertReportAudit("Retailer Wise Product IMS (Today)");
                        //int count = 0;
                        List<RetailerProductImsBEL> item;
                        item = (from DataRow row in dt.Rows
                                select new RetailerProductImsBEL
                                {
                                    //SlNo = ++count,
                                    ...
                                    NumberOfInvoice = Convert.ToInt32(row["NUMBER_OF_INVOICE"]),
        ...
        public object GetRetailerProductImsDateRange(string fDate, string tDate, string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                int userId = Convert.ToInt32(HttpContext.Current.Session["USER_ID"]);
                ...
                using (OracleConnection objConn = new OracleConnection(ConnString))
                {
                    ...
                    {
                        objCmd.Connection = objConn;
                        objCmd.CommandText = "FN_RET_PROD_IMS_DATE_RANGE";
                        objCmd.CommandType = CommandType.StoredProcedure;
                        ...
                        _dbHelper.InsertReportAudit("Retailer Wise Product IMS (Custom Date)");
        ...
        public List<RetailerProductImsBEL> GetRetailerProductImsYesterday(string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                ...
                //DataTable dt = _dbHelper.GetDataTable(qry);
                DataTable dt = _dbHelper.GetDataTableWithAuditTrial(qry, "Retailer Wise Product IMS (Yesterday)");
        ...
        public List<RetailerProductImsBEL> GetRetailerProductImsLastSevendays(string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                ...
                if (UserAccessCount > 0)
                {
                         ...
                         qry = " SELECT DIVISION_CODE, DIVISION_NAME, REGION_CODE, REGION_NAME, AREA_CODE, AREA_NAME, TERRITORY_CODE, TERRITORY_NAME, MARKET_CODE, MARKET_NAME, CUSTOMER_CODE, CUSTOMER_NAME, DB_LOCATION, ROUTE_CODE, ROUTE_NAME, RETAILER_CODE, RETAILER_NAME,BASE_PRODUCT_CODE, BASE_PRODUCT_NAME, BRAND_CODE, BRAND_NAME, PRODUCT_CATEGORY_CODE, PRODUCT_CATEGORY_NAME, PRODUCT_CODE, PRODUCT_NAME, PACK_SIZE, PRODUCT_PRICE, INVOICE_AMT, SALES_QTY, SALES_BONUS_QTY, BONUS_PRICE_DISCOUNT, REPLACE_QTY, RETURN_SALES_QTY, RETURN_BNS_QTY, IMS_SALES_QTY, IMS_BNS_QTY, RETURN_VALUE, BNS_DISC_RET, DISCOUNT_VAL, NET_IMS, NUMBER_OF_INVOICE " +
                              " FROM MV_RET_PROD_IMS_LAST_7DAYS " +
                              " WHERE (DIVISION_CODE = '" + dCode + "' OR '" + dCode + "' = 'ALL')" +
                              " AND   (REGION_CODE='" + rCode + "' OR '" + rCode + "'='ALL')" +
                              " AND   (AREA_CODE='" + aCode + "' OR '" + aCode + "'='ALL')" +
                              " AND   (TERRITORY_CODE='" + tCode + "' OR '" + tCode + "'='ALL')" +
                ...
                //DataTable dt = _dbHelper.GetDataTable(qry);
                DataTable dt = _dbHelper.GetDataTableWithAuditTrial(qry, "Retailer Wise Product IMS (Last Seven Days)");
        ...
        public List<RetailerProductImsBEL> GetRetailerProductImsLastThirtydays(string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                ...
                if (UserAccessCount > 0)
                {
                        ...
                        qry = " SELECT DIVISION_CODE, DIVISION_NAME, REGION_CODE, REGION_NAME, AREA_CODE, AREA_NAME, TERRITORY_CODE, TERRITORY_NAME, MARKET_CODE, MARKET_NAME, CUSTOMER_CODE, CUSTOMER_NAME, DB_LOCATION, ROUTE_CODE, ROUTE_NAME, RETAILER_CODE, RETAILER_NAME,BASE_PRODUCT_CODE, BASE_PRODUCT_NAME, BRAND_CODE, BRAND_NAME, PRODUCT_CATEGORY_CODE, PRODUCT_CATEGORY_NAME, PRODUCT_CODE, PRODUCT_NAME, PACK_SIZE, PRODUCT_PRICE, INVOICE_AMT, SALES_QTY, SALES_BONUS_QTY, BONUS_PRICE_DISCOUNT, REPLACE_QTY, RETURN_SALES_QTY, RETURN_BNS_QTY, IMS_SALES_QTY, IMS_BNS_QTY, RETURN_VALUE, BNS_DISC_RET, DISCOUNT_VAL, NET_IMS, NUMBER_OF_INVOICE" +
                              " FROM MV_RET_PROD_IMS_LAST_30DAYS " +
                              " WHERE (DIVISION_CODE = '" + dCode + "' OR '" + dCode + "' = 'ALL')" +
                              " AND   (REGION_CODE='" + rCode + "' OR '" + rCode + "'='ALL')" +
                              " AND   (AREA_CODE='" + aCode + "' OR '" + aCode + "'='ALL')" +
                              " AND   (TERRITORY_CODE='" + tCode + "' OR '" + tCode + "'='ALL')" +
                ...
                //DataTable dt = _dbHelper.GetDataTable(qry);
                DataTable dt = _dbHelper.GetDataTableWithAuditTrial(qry, "Retailer Wise Product IMS (Last Thirty Days)");
        ...
        public List<RetailerProductImsBEL> GetRetailerProductImsCurrentMonth(string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                ...
                if (UserAccessCount > 0)
                {
                        ...
                        qry = " SELECT DIVISION_CODE, DIVISION_NAME, REGION_CODE, REGION_NAME, AREA_CODE, AREA_NAME, TERRITORY_CODE, TERRITORY_NAME, MARKET_CODE, MARKET_NAME, CUSTOMER_CODE, CUSTOMER_NAME, DB_LOCATION, ROUTE_CODE, ROUTE_NAME, RETAILER_CODE, RETAILER_NAME, BASE_PRODUCT_CODE, BASE_PRODUCT_NAME, BRAND_CODE, BRAND_NAME, PRODUCT_CATEGORY_CODE, PRODUCT_CATEGORY_NAME,PRODUCT_CODE, PRODUCT_NAME, PACK_SIZE, PRODUCT_PRICE, INVOICE_AMT, SALES_QTY, SALES_BONUS_QTY, BONUS_PRICE_DISCOUNT, REPLACE_QTY, RETURN_SALES_QTY, RETURN_BNS_QTY, IMS_SALES_QTY, IMS_BNS_QTY, RETURN_VALUE, BNS_DISC_RET, DISCOUNT_VAL, NET_IMS, NUMBER_OF_INVOICE, TARGET_QTY,LAST_YEAR_AS_ON_DATE_IMS_QTY, LAST_YEAR_AS_ON_DATE_IMS_VAL " +
                              " FROM MV_RET_PROD_IMS_CMONTH " +
                              " WHERE (DIVISION_CODE = '" + dCode + "' OR '" + dCode + "' = 'ALL')" +
                              " AND   (REGION_CODE='" + rCode + "' OR '" + rCode + "'='ALL')" +
                              " AND   (AREA_CODE='" + aCode + "' OR '" + aCode + "'='ALL')" +
                              " AND   (TERRITORY_CODE='" + tCode + "' OR '" + tCode + "'='ALL')" +
                ...
                //DataTable dt = _dbHelper.GetDataTable(qry);
                DataTable dt = _dbHelper.GetDataTableWithAuditTrial(qry, "Retailer Wise Product IMS (Current Month)");
        ...
        public List<RetailerProductImsBEL> GetRetailerProductImsLastMonth(string dCode, string rCode, string aCode, string tCode, string cCode, string pBaseProductCode, string pBrandCode, string pCategoryCode, string pCode)
        {
            try
            {
                ...
                if (UserAccessCount > 0)
                {
                        ...
                        qry = " SELECT" +
                              " DIVISION_CODE, DIVISION_NAME, REGION_CODE, REGION_NAME, AREA_CODE, AREA_NAME, TERRITORY_CODE," +
                              " TERRITORY_NAME, MARKET_CODE, MARKET_NAME, CUSTOMER_CODE, CUSTOMER_NAME, DB_LOCATION," +
                              " ROUTE_CODE, ROUTE_NAME," +
                              " RETAILER_CODE, RETAILER_NAME," +
                              " BASE_PRODUCT_CODE, BASE_PRODUCT_NAME, BRAND_CODE, BRAND_NAME, PRODUCT_CATEGORY_CODE, PRODUCT_CATEGORY_NAME," +
                ...
                //DataTable dt = _dbHelper.GetDataTable(qry);
                DataTable dt = _dbHelper.GetDataTableWithAuditTrial(qry, "Retailer Wise Product IMS (Last Month)");
